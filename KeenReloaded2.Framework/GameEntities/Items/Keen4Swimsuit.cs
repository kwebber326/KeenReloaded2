...
{
    public class Keen4Swimsuit : CollisionObject, ISprite, IItemLevelObjective
    {
        private readonly int _zIndex;
        private bool _acquired;

        public Keen4Swimsuit(Rectangle area, SpaceHashGrid grid, int zIndex) : base(grid, area)
        {
            _zIndex = zIndex;
            this.HitBox = area;
        }
        ...
        public Image Image => Properties.Resources.keen4_swimsuit;
