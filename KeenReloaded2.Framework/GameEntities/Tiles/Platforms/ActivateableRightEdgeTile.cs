...
{
    public class ActivateableRightEdgeTile : RightEdgeFloorTile, IActivateable
    {
        public ActivateableRightEdgeTile(Rectangle area, SpaceHashGrid grid, Rectangle hitbox, string imageFile, int zIndex, string biome, bool isActive, Guid activationId)
        ...
        protected override void SetImageFromBiome()
        {
            switch (_biome)
            {
                ...
                case Biomes.BIOME_KEEN4_MIRAGE:
                    _image = _isActive
                        ? Properties.Resources.keen4_removable_platform_right_edge_filled
                        : Properties.Resources.keen4_removable_platform_right_edge;
                    break;
                case Biomes.BIOME_KEEN4_PYRAMID:
                    _image = _isActive
                        ? Properties.Resources.keen4_removable_platform_right_edge_filled_pyramid
                        : Properties.Resources.keen4_removable_platform_right_edge_pyramid;
                    break;
                case Biomes.BIOME_KEEN5_BLACK:
                    _image = _isActive
                         ? Properties.Resources.keen5_removable_platform_right_edge_filled_black
                         : Properties.Resources.keen5_removable_platform_right_edge_black;
                    break;
                case Biomes.BIOME_KEEN5_GREEN:
                    _image = _isActive
                         ? Properties.Resources.keen5_removable_platform_right_edge_filled_green
                         : Properties.Resources.keen5_removable_platform_right_edge_green;
                    break;
                case Biomes.BIOME_KEEN5_RED:
                    _image = _isActive
                         ? Properties.Resources.keen5_removable_platform_right_edge_filled_red
                         : Properties.Resources.keen5_removable_platform_right_edge_red;
                    break;
