...
namespace KeenReloaded2.Framework.GameEntities.Players
{
    ...
    {
        // TODO: remove when we are ready to implement player
        public CommanderKeen(SpaceHashGrid grid, Rectangle hitbox) : base(grid, hitbox)
        {
        }
        ...
        //        .Where(c => c is MaskedTile || ((c is PlatformTile || c is Platform || c is PoleTile) && c.HitBox.Top >= this.HitBox.Bottom)//PLATFORM CODE
