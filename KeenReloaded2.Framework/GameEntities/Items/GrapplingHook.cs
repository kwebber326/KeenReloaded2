...
{
    public class GrapplingHook : CollisionObject, ISprite, IItemLevelObjective
    {
        private readonly int _zIndex;
        private bool _acquired;

        public GrapplingHook(Rectangle area, SpaceHashGrid grid, int zIndex) : base(grid, area)
        {
            _zIndex = zIndex;
            this.HitBox = area;
        }
        ...
        public Image Image => Properties.Resources.keen6_grappling_hook;
        ...
        public WorldMapItemType ItemType => WorldMapItemType.GRAPPLING_HOOK;

        public override string ToString()
        {
            string separator = MapMakerConstants.MAP_MAKER_PROPERTY_SEPARATOR;
            string name = nameof(Properties.Resources.keen6_grappling_hook);
