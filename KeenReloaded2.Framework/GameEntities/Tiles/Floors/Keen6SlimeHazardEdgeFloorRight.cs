...
{
    public class Keen6SlimeHazardEdgeFloorRight : RightEdgeFloorTile, IUpdatable
    {
        ...
        public Keen6SlimeHazardEdgeFloorRight(Rectangle area, SpaceHashGrid grid, int zIndex, int currentSpriteIndex)
        ...
        {
            _sprites = SpriteSheet.SpriteSheet.Keen6SlimeHazardRightImages;
            this.UpdateSprite();
        ...
        private string GetImageNameFromCurrentSpriteIndex()
        {
            ...
            {
                case 1:
                    imageName = nameof(Properties.Resources.keen6_slime_hazard_right1);
                    break;
                case 2:
                    imageName = nameof(Properties.Resources.keen6_slime_hazard_right2);
                    break;
                case 3:
                    imageName = nameof(Properties.Resources.keen6_slime_hazard_right3);
                    break;
                default:
                    imageName = nameof(Properties.Resources.keen6_slime_hazard_right1);
                    break;
