...
namespace KeenReloaded2.Framework.GameEntities.AltCharacters
{
    ...
    {
        public Locoyorp(SpaceHashGrid grid, Rectangle hitbox, Direction direction) : base(hitbox, grid, direction)
        {
            Initialize();
        }

        public Locoyorp(SpaceHashGrid grid, Rectangle hitbox, Direction direction, int lives, long points) : base(hitbox, grid, direction, lives, points)
        {
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            {
                Properties.Resources.yorp_pogo_left1,
                Properties.Resources.yorp_pogo_left2,
            };
