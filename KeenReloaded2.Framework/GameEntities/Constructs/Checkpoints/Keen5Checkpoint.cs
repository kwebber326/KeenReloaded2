...
{
    public class Keen5CheckPoint : Checkpoint, IUpdatable, ICreateRemove
    {
        protected readonly Image[] _flagBase = new Image[]
        {
            Properties.Resources.keen5_flag_base1,
            Properties.Resources.keen5_flag_base2,
        };
        public Keen5CheckPoint(Rectangle area, SpaceHashGrid grid, int zIndex) : base(area, grid, zIndex)
        {
        ...
        protected SpinningCheckpointFlag _flag;
        ...
        {
            int width = Properties.Resources.keen5_flag1.Width;
            int height = Properties.Resources.keen5_flag1.Height;
            int x = this.HitBox.X + 16;
            int y = this.HitBox.Top - height + 2;
            _flag = new SpinningCheckpointFlag(_collisionGrid, new Rectangle(x, y, width, height), _zIndex);
        ...
        public override string ToString()
        {
            ...
            string imageName = nameof(Properties.Resources.keen5_flag_base1);
