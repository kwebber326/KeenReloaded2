...
{
    public class LeftEdgeWallTile : MaskedTile, IBiomeTile
    {
        ...
        protected virtual void SetImageFromBiome()
        {
            switch (_biome)
            {
                case Biomes.BIOME_KEEN4_CAVE:
                    _image = Properties.Resources.keen4_cave_wall_edge_left;
                    break;
                case Biomes.BIOME_KEEN4_FOREST:
                    _image = Properties.Resources.keen4_forest_wall_left_edge;
                    break;
                case Biomes.BIOME_KEEN4_PYRAMID:
                    _image = Properties.Resources.keen4_pyramid_wall_edge_left;
                    break;
                case Biomes.BIOME_KEEN4_MIRAGE:
                    _image = Properties.Resources.keen4_mirage_wall_left_edge;
                    break;
                case Biomes.BIOME_KEEN5_BLACK:
                    _image = Properties.Resources.keen5_wall_black_edge_left;
                    break;
                case Biomes.BIOME_KEEN5_GREEN:
                    _image = Properties.Resources.keen5_wall_green_edge_left;
                    break;
                case Biomes.BIOME_KEEN5_RED:
                    _image = Properties.Resources.keen5_wall_red_edge_left;
                    break;
                case Biomes.BIOME_KEEN6_DOME:
                    _image = Properties.Resources.keen6_dome_wall_edge_left;
                    break;
                case Biomes.BIOME_KEEN6_FOREST:
                    _image = Properties.Resources.keen6_forest_wall_edge_left;
                    break;
