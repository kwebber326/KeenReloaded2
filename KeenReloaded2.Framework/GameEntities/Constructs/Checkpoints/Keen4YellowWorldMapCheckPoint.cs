...
{
    public class Keen4YellowWorldMapCheckPoint : Keen4YellowCheckPoint, IActivator
    {
        private readonly List<IActivateable> _toggleObjects;
        private bool _isActive;

        public Keen4YellowWorldMapCheckPoint(Rectangle area, SpaceHashGrid grid, int zIndex,
        ...
        public override string ToString()
        {
            ...
            string imgName = nameof(Properties.Resources.keen4_flag_base_yellow) + "_wm";
