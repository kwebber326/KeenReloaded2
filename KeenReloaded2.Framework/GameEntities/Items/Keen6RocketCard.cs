...
{
    public class Keen6RocketCard : CollisionObject, ISprite, IItemLevelObjective
    {
        private readonly int _zIndex;
        private bool _acquired;

        public Keen6RocketCard(Rectangle area, SpaceHashGrid grid, int zIndex) : base(grid, area)
        {
            _zIndex = zIndex;
            this.HitBox = area;
        }
        ...
        public Image Image => Properties.Resources.keen6_rocket_card;
        ...
        public WorldMapItemType ItemType => WorldMapItemType.ROCKET_CARD;

        public override string ToString()
        {
            string separator = MapMakerConstants.MAP_MAKER_PROPERTY_SEPARATOR;
            string name = nameof(Properties.Resources.keen6_rocket_card);
