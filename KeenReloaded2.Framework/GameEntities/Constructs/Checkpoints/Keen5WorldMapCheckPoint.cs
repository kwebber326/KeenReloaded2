...
{
    public class Keen5WorldMapCheckPoint : Keen5CheckPoint, IActivator
    {
        private readonly List<IActivateable> _toggleObjects;
        private bool _isActive;

        public Keen5WorldMapCheckPoint(Rectangle area, SpaceHashGrid grid, int zIndex,
        ...
        public override string ToString()
        {
            ...
            string imgTag = nameof(Properties.Resources.keen5_flag_base1) + "_wm";
